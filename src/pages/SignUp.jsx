                ...
                <div className="grid h-screen place-items-center">
                    <div className="card flex-shrink-0 w-full lg:w-3/6 bg-base-100">
                        <div className="card-body">
                            <h1 className="text-center font-bold text-2xl">Getting Started</h1>
                            <h5 className="text-center font-medium text-lg mt-5 mb-7">Create an account to continue!</h5>
                            ...
                            <div className="form-control mt-7 rounded-2xl">
                                <label className="input-group input-group-md">
                                    ...
                                    <input type="text" placeholder="Your Name" className="input input-bordered input-md w-full border border-base-300" />
                                </label>
                            </div>
                            <div className="form-control mt-7 rounded-2xl">
                                <label className="input-group input-group-md">
                            ...
                            <div className="flex justify-items-start mt-7">
                                ...
                                <h6 className="font-medium text-lg">I agree to the Terms & Conditions</h6>
                            </div>
                            <div className="form-control mt-7 mt-6">
                                <button className="btn btn-primary rounded-2xl">Sign Up</button>
                            </div>
                            <h5 className="text-center font-medium text-lg mt-5 mb-9">Already have an account? <span className="text-primary"><Link to='signin'>Sign In</Link></span></h5>
                        </div>
                    </div>
                </div>
            </div>
